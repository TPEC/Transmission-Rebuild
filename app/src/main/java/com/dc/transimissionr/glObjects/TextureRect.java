...
import com.dc.transimissionr.glCore.ShaderUtil;
...
import static com.dc.transimissionr.glCore.ShaderUtil.createProgram;
...
public class TextureRect {
    ...
    float sRange=1f;//s纹理坐标范围
    float tRange=1f;//t纹理坐标范围
    ...
    public void initShader(MySurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("vertextex.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("fragtex.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
